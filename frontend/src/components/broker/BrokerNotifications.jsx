...
export function BrokerNotifications({ onNavigate, currentUserId }) {
  ...
  useEffect(() => {
    const fetchNotifications = async () => {
      try {
        ...
        console.log('[BrokerNotifications] Fetched notifications:', data);
        ...
        console.error('[BrokerNotifications] Failed to fetch notifications:', err);
  ...
  const handleNotificationClick = async (notification) => {
    console.log('[BrokerNotifications] Clicked notification:', notification);
    ...
    switch (notification.type) {
      ...
      case 'shipment-created':
        console.log('[BrokerNotifications] Routing to broker review for new shipment');
        onNavigate('broker-review', shipment);
        break;

      case 'ai-completed':
        console.log('[BrokerNotifications] Routing to broker review - AI analysis complete');
        onNavigate('broker-review', shipment);
        break;

      case 'document_request_fulfilled':
      case 'documents-uploaded':
        console.log('[BrokerNotifications] Routing to broker review - documents uploaded');
        onNavigate('broker-review', shipment);
        break;

      default:
        if (shipment) {
          console.log('[BrokerNotifications] Routing to broker review for unknown type');
          onNavigate('broker-review', shipment);
        }
    }
  };
  ...
  const getNotificationTitle = (notification) => {
    switch (notification.type) {
      case 'broker-approval-request':
        return 'Shipment Awaiting Review';
      case 'shipment-created':
